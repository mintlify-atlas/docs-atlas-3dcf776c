...
- [API Reference: Add Member](/api-reference/modpacks/members/add) - API endpoint for adding members
- [API Reference: Remove Member](/api-reference/modpacks/members/remove) - API endpoint for removing members